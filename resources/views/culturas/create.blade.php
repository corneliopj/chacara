...
<div class="row">
    {{-- COLUNA PRINCIPAL: FORMULÁRIO (8/12) --}}
    <div class="col-md-8">
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-seedling mr-1"></i> Registrar Nova Cultura</h3>
            </div>
            ...
            <form action="{{ route('culturas.store') }}" method="POST">
                ...
                <div class="card-body">
                    ...
                    {{-- LINHA 1: Área, Data Plantio, Colheita Prevista --}}
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            @error('colheita_prevista')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror {{-- <-- CORREÇÃO DA SINTAXE BLADE AQUI --}}
                        </div>
                    </div>

                    {{-- LINHA 2: Status Inicial, Estoque Mínimo --}}
                    <div class="row">
                        {{-- 5. Status Inicial --}}
    ...
    {{-- COLUNA LATERAL: Dica Rápida (4/12) --}}
    <div class="col-md-4">
        <div class="callout callout-info mt-4">
            <h5>Dica Rápida!</h5>
            <p>
                O registro da Cultura é o **ponto de partida** para toda a gestão financeira e de produção.
            </p>
            <p>
                O campo **Área (m²)** é fundamental para calcular indicadores de produtividade posteriormente.
            </p>
            <p>
                Após salvar, você poderá usar a tela de edição para registrar as despesas diretas e as receitas de venda.
            </p>
        </div>
    </div>
</div>
